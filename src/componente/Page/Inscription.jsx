...
function Inscription() {
  ...
  const [role, setRole] = useState('user'); // utilisateur ou mentor
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (role === 'mentor') {
        navigate('/MentorProfil'); // Page spécifique au mentor
      } else {
        navigate('/Profil'); // Page utilisateur classique
      }
    } catch (error) {
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="form-outline mb-4">
                    ...
                    >
                      ...
                      <option value="mentor">Mentor</option> {/* Correction du role mentor */}
                    </select>
                  </div>
